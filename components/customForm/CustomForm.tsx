...
export const CustomForm = () => {
  ...
  const allowedCountries: CountryCode[] = ['UA'];
      ...
      >
        <div className="">
          <p className="border-b-[3px] border-[#111827] py-1 mb-4 text-2xl uppercase text-[#111827]">
            КРОК 1. ЗАПОВНІТЬ СВОЮ КОНТАКТНУ ІНФОРМАЦІЮ
          </p>
        </div>
          ...
          >
            <label className="block text-sm font-medium text-gray-900">
              ...
              <Controller
                name="firstName"
                control={control}
                render={({ field }) => <Input {...field} placeholder="Ведіть Імя" />}
              />
            </label>
          ...
          <motion.div viewport={{ once: true }} variants={formAnimation} className="">
            <label className="block text-sm font-medium text-gray-900">
              ...
              <Controller
                name="lastName"
                control={control}
                render={({ field }) => <Input {...field} placeholder="Ведіть Призвіще" />}
              />
            </label>
          ...
          <motion.div viewport={{ once: true }} className="" variants={formAnimation}>
            <label className="block text-sm font-medium text-gray-900">
              ...
              <Controller
                name="email"
                control={control}
                render={({ field }) => <Input {...field} placeholder="Ведіть ваш email" />}
              />
            </label>
        ...
        <div className="">
          <p className="border-b-[3px] border-[#111827] py-1 mb-4 text-2xl uppercase text-[#111827]">
            КРОК 2. НАПИШІТЬ ЩО ВАС ЗАЦІКАВИЛО
          </p>
        </div>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <>
                    <CustomTextArea
                      {...field}
                      placeholder="Залиште коментар до форми"
                      maxLength={700}
                      onChange={(e) => {
              ...
              <div className="overflow-hidden flex focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-zinc-800 focus:border-zinc-800 w-full">
                ...
                <div className="flex items-center w-full">
                  ...
                  {arrayImages.length > 0 ? (
                    <span className="text-[#111827]">Завантажте файл {arrayImages.length} Фото</span>
                  ) : (
                    <span className="text-sm text-gray-400">Завантажте файл Фото</span>
                  )}
                </div>
              </div>
            </label>
