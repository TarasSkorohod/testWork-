...
export default function CeramicCoatings() {
  return (
    <div className="py-16 container">
      ...
      {/*  Ceramic <span className="text-[#203055]">Coatings</span>*/}
      {/*</Title>*/}
      ...
      {/*    </h6>*/}
      {/*    <TextPage cn="mb-8">*/}
      {/*      Discover the ultimate car body protection with <strong>System X®</strong>, one of the*/}
      {/*      finest and most durable ceramic coatings originally designed for the aviation industry,*/}
      {/*      trusted by renowned names like Sikorsky, Bombardier, and leading international airlines.*/}
      {/*      This revolutionary nano-ceramic breakthrough has paved the way for a comprehensive line*/}
      {/*      of products.*/}
      {/*    </TextPage>*/}
      {/*    <div>*/}
      {/*      With its exceptional hydrophobic properties, <strong>System X®</strong> offers:*/}
      {/*      <ul className="py-4 px-8">*/}
      {/*        <li className="text-[#111827] font-medium leading-7">*/}
      {/*          • The ability to repel dirt, water, dust, and debris, keeping the surface*/}
      {/*          immaculate.*/}
      {/*        </li>*/}
      {/*        <li className="text-[#111827] font-medium leading-7">*/}
      ...
      {/*        </li>*/}
      {/*        <li className="text-[#111827] font-medium leading-7">*/}
      {/*          • Impressive protection against external elements, unaffected by washing or*/}
      {/*          detailing.*/}
      {/*        </li>*/}
      {/*        <li className="text-[#111827] font-medium leading-7">*/}
      ...
      {/*  A single application of <strong>System X®</strong> ceramic car coating ensures years of*/}
